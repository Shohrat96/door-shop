        ...
        {!menuCollapsed ? (
          ...
          >
            ...
            <Menu.Item className={styles.navItem} key="3">
              <Link to="/useful">Bilmək faydalıdır</Link>
            </Menu.Item>
            {uid ? (
              <Menu.Item className={styles.navItem} key="4">
                <Link to="/orders">Sifarişlər</Link>
              </Menu.Item>
            ) : null}
            <Menu.Item className={styles.navItem} key="5">
              <Link to="/favorites">Bəyəndiklərim</Link>
            </Menu.Item>
            <Menu.Item className={styles.navItem} key="6">
              <Link to="/portfolio">Gördüyümüz işlər</Link>
            </Menu.Item>
          </Menu>
        ) : null}
      </div>
